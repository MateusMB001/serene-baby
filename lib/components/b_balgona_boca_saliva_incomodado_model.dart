...
class BBalgonaBocaSalivaIncomodadoModel extends FlutterFlowModel {
  ///  State fields for stateful widgets in this component.

  // State field(s) for PVBBbocasalivandoIncomodado widget.
  PageController? pVBBbocasalivandoIncomodadoController;
