...
import 'mamae_motivacional_chorando_model.dart';
export 'mamae_motivacional_chorando_model.dart';

class MamaeMotivacionalChorandoWidget extends StatefulWidget {
  const MamaeMotivacionalChorandoWidget({Key? key}) : super(key: key);

  @override
  _MamaeMotivacionalChorandoWidgetState createState() =>
      _MamaeMotivacionalChorandoWidgetState();
}

class _MamaeMotivacionalChorandoWidgetState
    extends State<MamaeMotivacionalChorandoWidget> {
  late MamaeMotivacionalChorandoModel _model;

  int get pVmamaeChorandoCurrentIndex =>
      _model.pVmamaeChorandoController != null &&
              _model.pVmamaeChorandoController!.hasClients &&
              _model.pVmamaeChorandoController!.page != null
          ? _model.pVmamaeChorandoController!.page!.round()
          : 0;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MamaeMotivacionalChorandoModel());
  }
      ...
      child: Container(
        ...
        child: Container(
          ...
          child: PageView(
            ...
            controller: _model.pVmamaeChorandoController ??=
            ...
            children: [
              Stack(
                children: [
                          ...
                          children: [
                            InkWell(
                              onTap: () async {
                                ...
                                await _model.pVmamaeChorandoController
                                    ?.nextPage(
                            ...
                            InkWell(
                              onTap: () async {
                                setState(() {
                                  FFAppState().BBmamouChorando = 'abrir';
                                });
                              },
                              child: Material(
                                color: Colors.transparent,
                  ...
                  if (FFAppState().BBmamouChorando == 'abrir')
                    wrapWithModel(
                      model: _model.bebeMamouChorandoModel1,
                      updateCallback: () => setState(() {}),
                      child: BebeMamouChorandoWidget(),
                    ),
                ],
              ),
              Column(
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () async {
                            await _model.pVmamaeChorandoController?.nextPage(
                              duration: Duration(milliseconds: 300),
                              curve: Curves.ease,
                            );
                          },
              ...
              Stack(
                children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () async {
                                setState(() {
                                  FFAppState().BBmamouChorando = 'aberto';
                                });
                              },
                              child: Material(
                                color: Colors.transparent,
                  ...
                  if (FFAppState().BBmamouChorando == 'aberto')
                    wrapWithModel(
                      model: _model.bebeMamouChorandoModel2,
                      updateCallback: () => setState(() {}),
                      child: BebeMamouChorandoWidget(),
                    ),
                ],
