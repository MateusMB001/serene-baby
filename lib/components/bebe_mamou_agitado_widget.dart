...
import 'bebe_mamou_agitado_model.dart';
export 'bebe_mamou_agitado_model.dart';

class BebeMamouAgitadoWidget extends StatefulWidget {
  const BebeMamouAgitadoWidget({Key? key}) : super(key: key);

  @override
  _BebeMamouAgitadoWidgetState createState() => _BebeMamouAgitadoWidgetState();
}

class _BebeMamouAgitadoWidgetState extends State<BebeMamouAgitadoWidget> {
  late BebeMamouAgitadoModel _model;

  int get pVBebeMamouCurrentIndex => _model.pVBebeMamouController != null &&
          _model.pVBebeMamouController!.hasClients &&
          _model.pVBebeMamouController!.page != null
      ? _model.pVBebeMamouController!.page!.round()
      : 0;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BebeMamouAgitadoModel());
  }
    ...
    return Container(
      ...
      child: Container(
        ...
        child: PageView(
          ...
          controller: _model.pVBebeMamouController ??=
          ...
          children: [
                    ...
                    children: [
                      InkWell(
                        onTap: () async {
                          ...
                          await _model.pVBebeMamouController?.nextPage(
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      InkWell(
                        onTap: () async {
                          await _model.pVBebeMamouController?.previousPage(
                            duration: Duration(milliseconds: 300),
                            curve: Curves.ease,
                          );
                        },
            ...
            Stack(
              children: [
                if (FFAppState().banhoMorno == 'abrir')
                  wrapWithModel(
                    model: _model.banhoMornoAgitadoModel1,
                    updateCallback: () => setState(() {}),
                    child: BanhoMornoAgitadoWidget(),
                  ),
                if (FFAppState().bebeMamou == 'Não')
                  Column(
                    mainAxisSize: MainAxisSize.max,
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            InkWell(
                              onTap: () async {
                                await _model.pVBebeMamouController
                                    ?.previousPage(
                                  duration: Duration(milliseconds: 300),
                                  curve: Curves.ease,
                                );
            ...
            Visibility(
              visible: FFAppState().banhoMorno == 'aberto',
              child: wrapWithModel(
                model: _model.banhoMornoAgitadoModel2,
                updateCallback: () => setState(() {}),
                child: BanhoMornoAgitadoWidget(),
              ),
            ),
