            ...
            children: [
                    ...
                    Expanded(
                      child: Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            20.0, 0.0, 10.0, 0.0),
                        child: Text(
                          'Todos os vídeos e músicas desse aplicativo estão assegurados pela Royalty-Free License, Creative Commons Attribuition 3.0 (CC-BY 3.0) License e Videvo Attribution License.',
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Image.asset(
                      'assets/images/Logo_fonte_branca_(1).png',
                      width: 100.0,
                      height: 100.0,
                      fit: BoxFit.fill,
                    ),
                    ...
                    Expanded(
                      child: Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            15.0, 0.0, 15.0, 0.0),
                        child: Text(
                          'Insperis Soluçoes e Consultoria em Sistemas LTDA',
                          textAlign: TextAlign.center,
                          style: FlutterFlowTheme.of(context)
                              .bodyMedium
                              .override(
                  ...
                  children: [
                    Expanded(
                      child: Padding(
                        ...
                        child: InkWell(
                          onTap: () async {
                            await launchURL('http://insperis.tech');
                          },
                          child: Text(
                            'http://insperis.tech',
                            textAlign: TextAlign.center,
